...
const SYSTEM_PROMPT = [
  ...
  "5. 제품명·브랜드는 표시사항 블록 안의 '제품명' · '업소명(제조원/판매원)' 항목에서 찾는다.",
  "   한국 식품 표시사항은 원재료명과 같은 블록에 제품명을 함께 적게 되어 있다.",
  "   사진에 그 항목이 안 보이면 포장 앞면 문구로 추측하지 말고 null 을 넣는다.",
  "6. 영양성분은 총 내용량 기준 수치를 숫자로만 넣는다. 단위 문자는 넣지 않는다.",
  ...
  "8. 판정에 해당하는 말(안전/위험/점수)은 절대 쓰지 않는다. 판독만 한다.",
  "",
